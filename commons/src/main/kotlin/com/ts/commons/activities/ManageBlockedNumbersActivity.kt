package com.ts.commons.activities
...
import com.ts.commons.adapters.ManageBlockedNumbersAdapter
import com.ts.commons.dialogs.AddBlockedNumberDialog
import com.ts.commons.dialogs.ExportBlockedNumbersDialog
import com.ts.commons.dialogs.FilePickerDialog
import com.ts.commons.extensions.*
import com.ts.commons.helpers.*
import com.ts.commons.helpers.BlockedNumbersExporter.ExportResult
import com.ts.commons.interfaces.RefreshRecyclerViewListener
...
class ManageBlockedNumbersActivity : BaseSimpleActivity(), RefreshRecyclerViewListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val blockTitleRes = if (baseConfig.appId.startsWith("com.ts.dialer")) R.string.block_unknown_calls else R.string.block_unknown_messages
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.ts.dialer")) {
