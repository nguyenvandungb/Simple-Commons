...
import com.ts.commons.models.MyTheme
import com.ts.commons.models.RadioItem
import com.ts.commons.models.SharedTheme
import com.ts.commons.views.MyTextView
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isThankYou = packageName.removeSuffix(".debug") == "com.ts.thankyou"
        initColorVariables()
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.ts.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
