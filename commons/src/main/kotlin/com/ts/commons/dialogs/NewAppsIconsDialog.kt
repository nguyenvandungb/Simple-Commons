...
import com.ts.commons.extensions.launchViewIntent
...
class NewAppsIconsDialog(val activity: Activity) {
    init {
        val view = activity.layoutInflater.inflate(R.layout.dialog_new_apps_icons, null).apply {
            val dialerUrl = "https://play.google.com/store/apps/details?id=com.ts.dialer"
            val smsMessengerUrl = "https://play.google.com/store/apps/details?id=com.ts.smsmessenger"
            val voiceRecorderUrl = "https://play.google.com/store/apps/details?id=com.ts.voicerecorder"
