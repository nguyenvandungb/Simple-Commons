...
import com.ts.commons.dialogs.ConfirmationAdvancedDialog
import com.ts.commons.dialogs.RateStarsDialog
...
class AboutActivity : BaseSimpleActivity() {
    ...
    private fun setupPrivacyPolicy() {
        ...
        inflater?.inflate(R.layout.item_about, null)?.apply {
            ...
            setOnClickListener {
                val appId = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.ts.")
