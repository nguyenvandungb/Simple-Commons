...
import com.ts.commons.asynctasks.CopyMoveTask
import com.ts.commons.dialogs.*
import com.ts.commons.dialogs.WritePermissionDialog.Mode
import com.ts.commons.extensions.*
import com.ts.commons.helpers.*
import com.ts.commons.interfaces.CopyMoveListener
import com.ts.commons.models.FAQItem
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.ts.", true)) {
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.ts.")
