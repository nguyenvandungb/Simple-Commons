...
import com.ts.commons.extensions.getIntValue
import com.ts.commons.extensions.getStringValue
import com.ts.commons.models.PhoneNumber
import com.ts.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.ts.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.ts.dialer" && packageName != "com.ts.smsmessenger" && packageName != "com.ts.calendar.pro") {
                return contacts
            }
