...
import com.ts.commons.helpers.*
import com.ts.commons.models.AlarmSound
import com.ts.commons.models.BlockedNumber
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.ts.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.ts.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.ts.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.ts."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.ts.contacts") && !packageName.startsWith("com.ts.dialer")) {
        true
    } else if ((packageName.startsWith("com.ts.contacts") || packageName.startsWith("com.ts.dialer")) && isQPlus()) {
